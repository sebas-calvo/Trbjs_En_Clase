 ...
 */
package Unidad_03_3.vista;

//import Unidad_03_2.vista.*;
...
public class Ventana0303a extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        switch (e.getActionCommand()) {
            case "Guardar":
                System.out.println("Dio click en el boton guardar");
                break;
            case "Cancelar":
                System.out.println("Dio click en el boton cancelar");
                break;
            case "Varón":
                System.out.println("Dio click en el boton varon");
                break;
            case "Mujer":
                System.out.println("Dio click en el boton mujer");
                break;
            case "Arquero":
                System.out.println("Dio click en el boton arquero");
                break;
            case "Defensa":
                System.out.println("Dio click en el boton defensa");
                break;
            case "Mediocampo":
                System.out.println("Dio click en el boton mediocampo");
                break;
            case "Delantero":
                System.out.println("Dio click en el boton delantero");
                break;
            default:
                break;
        }
